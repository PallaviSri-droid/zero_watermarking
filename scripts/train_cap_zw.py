...
from zero_watermarking.training import CAP_ZW_VERSION, CAPZWHashNet, PairAttackDataset, TrainConfig, train_cap_zw
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Train the configured CAP-ZW model.")
    ...
    parser.add_argument("--binary-collision-target", type=float, default=0.14, help="Minimum normalized Hamming distance for thresholded-code negatives.")
